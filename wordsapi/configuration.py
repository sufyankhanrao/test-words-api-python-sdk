...
class Configuration(HttpClientConfiguration):
    ...
    def x_rapid_api_key(self):
        return self._custom_header_authentication_credentials.x_rapid_api_key
    ...
    def create_auth_credentials_object(x_rapid_api_key,
        ...
        warnings.warn(message=('The \'x_rapid_api_key\' params are deprecated. '
                               'Use \'custom_header_authentication_credentials'
                               '\' param instead.'),
        ...
        from wordsapi.http.auth.custom_header_authentication import CustomHeaderAuthenticationCredentials
        return CustomHeaderAuthenticationCredentials(x_rapid_api_key)
